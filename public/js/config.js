 ...
 * -------------------------------------------------------------------------- */
const CHRONO = {
  // Источник норматива — для подписи на странице. Замените, когда придёт эксель Гарри.
  source: 'ЧЕРНОВИК (заглушка) — заменить на хронометраж Гарри',
  isDraft: true,

  // Минут на одну услугу данного типа. Заменяется значениями из экселя Гарри.
  minutesPerUnit: {
    invoice_issued:       5,
    invoice_received:     4,
    report:               20,
    tax_invoice_issued:   6,
    tax_invoice_received:  5,
  },
